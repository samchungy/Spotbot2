...
const getSettingsBlocks = (settings) => {
  if (!settings) {
  ...
  return [
    ...
    textInput(SETTINGS.skip_votes, LABELS.skip_votes, HINTS.skip_votes, settings.skip_votes, LIMITS.skip_votes, PLACE.skip_votes),
