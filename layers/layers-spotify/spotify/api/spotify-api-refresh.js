...
const {storeTokens} = require('../../components/settings/spotifyauth/spotifyauth-dal');
const {storeDefaultDevice, storePlaylist} = require('../../components/settings/settings-interface');
